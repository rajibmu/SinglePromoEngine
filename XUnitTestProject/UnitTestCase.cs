...
namespace XUnitTestProject
{
    public class UnitTestCase
    {
        ...
        public void Test_PromoEngine_Calculate()
        {
            ...
            var promotions = new List<Promotion>() { new Promotion(1, new List<char> { 'A' }, 3, 130), new Promotion(1, new List<char> { 'B' }, 2, 45)};
            var cart = new Dictionary<char, int> { { 'A', 5 }, { 'B', 5 }, { 'C', 1 } };
